...
│   ├── test_model.py              # Model persistence & loading tests
...
| `OSRM_TIMEOUT_SECONDS` | `3.0` | Per-request timeout in seconds. |
| `OSRM_MAX_RETRIES` | `2` | Number of retry attempts on network / 5xx errors. |
| `OSRM_RETRY_BACKOFF_SECONDS` | `0.25` | Base backoff interval between retries. |
